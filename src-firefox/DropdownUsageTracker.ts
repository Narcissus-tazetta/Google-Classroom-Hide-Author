export class DropdownUsageTracker {
    ...
    private useBrowserStorage = typeof browser !== "undefined" && browser.storage?.local;
    ...
    private tryApplyCssOrder(
        dropdown: HTMLElement,
        scored: Array<{ el: HTMLElement; score: number; originalIndex: number }>
    ): boolean {
        try {
